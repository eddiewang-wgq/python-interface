...
test_data_path = project_path + '\\test_data\\'
test_report_path = project_path + '\\test_report\\'
test_log_path = project_path + '\\test_log\\'
test_screenshot_path = project_path + '\\test_screenshot\\'
